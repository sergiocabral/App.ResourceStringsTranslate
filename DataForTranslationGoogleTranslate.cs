namespace ResourceStringsTranslate
{
    public class DataForTranslationGoogleTranslate
    {
        ...
        public const string UrlValue = "https://translate.google.com.br/translate_a/single?client=gtx&sl=" + UrlMarkLanguageFrom + "&tl=" + UrlMarkLanguageTo + "&hl=" + UrlMarkLanguageFrom + "&dt=at&dt=bd&dt=ex&dt=ld&dt=md&dt=qca&dt=rw&dt=rm&dt=ss&dt=t&otf=1&ssel=0&tsel=0&kc=7&q=" + UrlMarkText;
        ...
        public static DataForTranslationGoogleTranslate Default() =>
            new DataForTranslationGoogleTranslate
            {
                Url = UrlValue,
                BetweenRequests = 5,
                AfterBlock = 3600
